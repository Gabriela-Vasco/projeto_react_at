...
const Home = () => {
    ...
    const loadData = async () => {
        const d = await list("action_student");
        const profile = await get("profile_student", [{field: "user_id", value: user.id }]);
        setProfile(profile);
